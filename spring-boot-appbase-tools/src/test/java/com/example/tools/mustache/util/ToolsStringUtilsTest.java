package com.example.tools.mustache.util;
...
class ToolsStringUtilsTest {

    @Test
    void testToLowerSnakeCase() {
        Assertions.assertEquals("", ToolsStringUtils.toLowerSnakeCase(""));
        Assertions.assertEquals("", ToolsStringUtils.toLowerSnakeCase("_"));
    ...
    private void testToLowerSnakeCase(String expected, String text) {
        Assertions.assertEquals(expected, ToolsStringUtils.toLowerSnakeCase(text));
        Assertions.assertEquals(expected, ToolsStringUtils.toLowerSnakeCase("_" + text));
        Assertions.assertEquals(expected, ToolsStringUtils.toLowerSnakeCase(text + "_"));
        Assertions.assertEquals(expected, ToolsStringUtils.toLowerSnakeCase("_" + text + "_"));
    }

    @Test
    void testToLowerTrainCase() {
        Assertions.assertEquals("", ToolsStringUtils.toLowerTrainCase(""));
        Assertions.assertEquals("", ToolsStringUtils.toLowerTrainCase("-"));
    ...
    private void testToLowerTrainCase(String expected, String text) {
        Assertions.assertEquals(expected, ToolsStringUtils.toLowerTrainCase(text));
        Assertions.assertEquals(expected, ToolsStringUtils.toLowerTrainCase("-" + text));
        Assertions.assertEquals(expected, ToolsStringUtils.toLowerTrainCase(text + "-"));
        Assertions.assertEquals(expected, ToolsStringUtils.toLowerTrainCase("-" + text + "_"));
    }
    ...
    private void testSplitWords(List<String> expected, String text) {
        Assertions.assertIterableEquals(expected, //
                ReflectionTestUtils.invokeMethod(//
                        ToolsStringUtils.class, "splitWords", text));
        Assertions.assertIterableEquals(expected, //
                ReflectionTestUtils.invokeMethod(//
                        ToolsStringUtils.class, "splitWords", "-" + text));
        Assertions.assertIterableEquals(expected, //
